...
function App() {
  ...
  function getCharClass(wordIdx, charIdx, char) {
    if (wordIdx === currWordIndex && charIdx === currCharIndex && currChar && status !== 'success') {
      if (char === currChar) {
  ...
  return (
    <div className="App">
      ...
      <div className="control is-expanded section">
        ...
        onKeyDown={handleKeyDown} value={currInput} onChange={(e) => setCurrInput(e.target.value)}  />
      </div>
      <div className="section">
      ...
      {status === 'success' && (
        <div className="section">
          <div className="columns">
            ...
            <div className="column has-text-centered">
              <p className="is-size-5">My best time:</p>
              {correct !== 0 ? (
